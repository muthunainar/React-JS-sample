        ...
        <div className="row">
          <div className="col-3">
            <form>
              ...
              <br />
              <label className="classlabel">Book Title:{" "}
                <input type="text"value={getSearch}onChange={onChangeSearchHandler}id="bookName"name="searchbookName"/></label>
              <br />
            ...
            {getList.map((obj, index) => {
              return (
                <tr key={index}>
                  ...
                  <td>{obj.avail}</td>
                  <td>
                    <i onClick={() => onEditHandler(index)}data-toggle="modal"className="fa fa-pencil"aria-hidden="true"data-target="#edit"></i>
                  </td>
                  <td>
                    <i onClick={() => onDeleteHandler(index)}data-toggle="modal"className="fa fa-trash"aria-hidden="true"data-target="#delete"></i>
              ...
              <form className="classform1">
                ...
                <table>
                  <tbody>
                    <tr>
                      <td>
                        <div className="form-group"><label>Book Title:</label></div>
                      </td>
                      <td>
                        <input type="text"value={getBook.title}onChange={onChangeHandler}id="title"className="classlabel"name="title"/>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div className="form-group"><label>Book Details:</label></div>
                      </td>
                      <td>
                        <input type="text"value={getBook.desc}onChange={onChangeHandler}id="desc"className="classlabel"name="desc"/>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div className="form-group"><label>Author Name:</label></div>
                      </td>
                      <td>
                        <input type="text"value={getBook.author}onChange={onChangeHandler}id="name"className="classlabel"name="author"/>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div className="form-group"><label>Number of <br />Book Available:</label></div>
                      </td>
                      <td>
                        <input type="number"value={getBook.avail}onChange={onChangeHandler}id="number"className="classlabel"name="avail"/>
                      </td>
                    </tr>
                    <tr>
                      <td></td>
      ...
      <div className="modal" id="delete" role="dialog">
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            ...
            <div className="modal-body">Successfully Deleted Book Details</div>
            <div className="modal-footer">
